  ...
  cron.schedule('*/10 * * * *', () => {
    ...
    api.getThreadList(25, null, ['INBOX'], async (err, data) => {
      ...
      async function message(thread) {
        try {
          api.sendMessage({
            body: `⟩Thank you for using ST2B Messenger Chatbot!\n\n⟩ Hope this Chatbot by STEM-2B helps you in your studies\n\n⟩ For your concerns about this bot, kindly add and follow me on FB: https://www.facebook.com/JOSHYVREK24`
          }, thread.threadID, (err) => {
            if (err) return;
